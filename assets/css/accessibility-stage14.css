...
/* Mobile/touch visitors get the static LCP hero only. The decorative hover video
   remains a desktop enhancement and cannot become an accidental mobile tap target. */
@media (max-width:680px), (hover:none), (pointer:coarse){
  .hero.hero-image-first .hero-video{display:none!important;visibility:hidden!important;}
