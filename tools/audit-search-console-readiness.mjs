...
console.log(`Strict E-E-A-T / Search Console source readiness passed: canonical brand semantics, truthful production sitemap contract and ${profilePageCount} ProfilePage node(s) are coherent; ${profileDateCreatedCount} optional dateCreated value(s) validated.`);
