...
must(boot.includes('/assets/css/fluid-4k-rhythm.css?v=20260916-live-pixel-v19'),'live-pixel cache token missing');
must(optimizer.includes('/assets/css/fluid-4k-rhythm.css?v=20260916-live-pixel-v19'),'production artifact must parser-discover the same canonical geometry CSS token');
...
must(fluid.includes('LIVE-PIXEL-GEOMETRY-V19'),'canonical live-pixel stylesheet marker missing');
