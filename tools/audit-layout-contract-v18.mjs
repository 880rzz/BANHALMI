...
must(boot.includes('/assets/css/fluid-4k-rhythm.css?v=20260917-footer-v21'),'footer V21 cache token missing');
must(optimizer.includes('/assets/css/fluid-4k-rhythm.css?v=20260917-footer-v21'),'production artifact must parser-discover the same canonical geometry CSS token');
...
must(fluid.includes('FOOTER-DESKTOP-GEOMETRY-V21-FLUID:START'),'canonical footer/layout stylesheet marker missing');
