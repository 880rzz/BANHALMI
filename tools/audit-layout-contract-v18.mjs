...
must(fluid.trimEnd().endsWith('/* LIVE-PIXEL-GEOMETRY-V22 */'),'canonical V22 live-pixel stylesheet marker must be final');
...
console.log('BANHALMI layout contract v22 passed: canonical CSS is parser-discovered in production, runtime only synchronizes disclosure state, desktop H1 is >=40px, and 4/5/6-column portrait density is protected through 4K.');
