...
console.log('BANHALMI layout contract v18 passed: pixel geometry is canonical CSS authority, runtime only loads CSS and synchronizes disclosure state, and 4/5/6-column portrait density is protected through 4K.');
