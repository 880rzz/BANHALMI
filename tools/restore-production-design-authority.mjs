...
const constitutionCss=fs.readFileSync('assets/css/design-constitution.css','utf8');
const targetCss=path.join(siteRoot,'assets/css/site.css');
const targetConstitution=path.join(siteRoot,'assets/css/design-constitution.css');
...
if(fs.existsSync(targetConstitution)) fs.rmSync(targetConstitution,{force:true});
