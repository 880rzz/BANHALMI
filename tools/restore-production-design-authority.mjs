...
console.log(`BANHALMI production design compiled from ${design.version}; ${checked} HTML files checked, ${normalized} artifact HTML file(s) normalized, ${privateInjected} private-event quote adapter injection(s), ${pdfPatched} PDF label patch(es). Standard and structured canvases, canonical content-axis, text-only active navigation, content-height footer and card rhythm projections are active.`);
