...
must(Number(authority.layout?.documentFlow?.footerMaxViewportFractionOnTabletDesktop)<=0.4,'BANHALMI visual footer threshold must remain 0.4 or tighter');
must(Number(authority.layout?.documentFlow?.footerAbsoluteMaxPx)<=360,'BANHALMI desktop footer absolute maximum must remain 360px');
...
must(Number(authority.layout?.footer?.primaryRows)===1,'BANHALMI desktop footer primary band must remain one rendered row');
...
must(Number(authority.layout?.footer?.paddingTopPx)===18&&Number(authority.layout?.footer?.paddingBottomPx)===12,'BANHALMI footer padding authority changed');
must(Number(authority.layout?.footer?.desktopGapPx)===16,'BANHALMI desktop footer gap authority changed');
