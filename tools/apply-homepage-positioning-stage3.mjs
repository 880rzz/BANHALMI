...
const configs = {
  ...
  'hu/index.html': {
    ...
    summary:'<p><strong>Négy fő szolgáltatás:</strong> executive portréfotózás, brandfotózás, C-level eseményfotózás és művészi fotográfia.</p><p>A headshot, az employer branding, a sajtóportré és a vizuális márkastratégia ezeket a területeket támogatja. Nem különálló, egymással versengő szolgáltatások.</p>',
...
console.log('Stage-three homepage positioning migration updated EN, HU and DE-AT homepages.');
