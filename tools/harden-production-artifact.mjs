...
/* LIVE-PIXEL-GEOMETRY-V22 is already canonical source CSS. Hardening may
   validate it, but must never regenerate or append footer/card geometry. */
...
if (!fluidCss.trimEnd().endsWith('/* LIVE-PIXEL-GEOMETRY-V22 */')) throw new Error('Canonical V22 geometry marker must remain the final stylesheet authority.');
