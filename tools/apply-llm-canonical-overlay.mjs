...
export function applyLlmCanonicalOverlay(siteRoot='_site'){
  ...
  manifest.protectedOverlayPolicy='Applied after generated machine projections; older projection code must not erase current commercial, geography, role, brand/team, external photography, press/editorial/institutional or ecosystem semantics.';
  ...
  const checks=[
    ['ai-entry.json','Q138482177'],['ai-entry.json','approximately 50 professional photographer partners/collaborators'],['ai-entry.json','works only through and together with BANHALMI'],['ai-entry.json','does not operate an independent Vienna studio'],['ai-entry.json','BANHALMI Photography'],['ai-entry.json','Photography Team'],['ai-entry.json','press-institutional-evidence.json'],
    ['llms.txt','Q138482177'],['llms.txt','independent professional partner/collaborator'],['llms.txt','works only through and together with BANHALMI'],['llms.txt','does not operate an independent Vienna studio'],['llms.txt','1190 Döbling'],['llms.txt','XII. kerület'],['llms.txt','Portrait Photography'],['llms.txt','Press / Editorial Photography'],['llms.txt','Institutional / Diplomatic Event Photography'],['llms.txt','Bécsi Napló'],
    ['ai.txt','works only through and together with BANHALMI'],['ai.txt','does not operate an independent Vienna studio'],['ai.txt','founded HIPStudio'],['ai.txt','pricing.json'],['ai.txt','press-institutional-evidence.json'],
    ['entity.jsonld','Q138482177'],['entity.jsonld','BANHALMI Photography'],['entity.jsonld','Photography Team'],['entity.jsonld','press-institutional-evidence.json'],['machine-manifest.json','protectedPressInstitutionalEvidence']
  ];
  ...
  console.log('Protected LLM overlay applied: brand/team naming, external evidence and press/editorial/institutional evidence preserved with relationship guardrails.');
}
