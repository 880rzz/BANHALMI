...
if (!viennaStudio || !/studio/i.test(String(viennaStudio.locationType || '')) || viennaStudio.postalCode !== '1010' || !String(viennaStudio.streetAddress || '').includes('Schwedenplatz 2')) errors.push('ai-entry.json Vienna studio role drifted');
if (!budapestStudio || !/studio/i.test(String(budapestStudio.locationType || '')) || !String(budapestStudio.district || '').includes('District 11')) errors.push('ai-entry.json Budapest studio role drifted');
