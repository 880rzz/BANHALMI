...
for(const token of ['--navy:#202530','--graphite:#202530','--ink:#202530','.site-footer{background:#202530']) if(!css.includes(token)) throw new Error(`Missing blue palette contract: ${token}`);
...
console.log('BANHALMI blue palette WCAG contrast audit passed.');
