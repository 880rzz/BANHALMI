...
// Keep the HUF planning mirror and the browser-embedded canonical pricing payload synchronized.
text = text.replace(
...
// Align quote-page WebPage nodes with the already-expanded EN/HU/DE search metadata.
text = text.replace(
...
console.log('Artists & Performers migration quality patch applied: canonical/HUF/embedded pricing synchronized, Schema parity enforced, customer-intent reference added, executive-first identity retained.');
