...
for(const t of ['mega-menu.css?v=20260810-menu-fullscreen-v64','mega-menu.js?v=20260810-menu-fullscreen-v64'])if(!config.includes(t))errors.push('site-config.js missing '+t);
