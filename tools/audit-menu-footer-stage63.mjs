...
for(const t of ['mega-menu.css?v=20260810-menu-footer-v63','mega-menu.js?v=20260810-menu-footer-v63'])if(!config.includes(t))errors.push('site-config.js missing '+t);
