...
const pages={
  'index.html':{
    ...
    newFacts:['Executive Portraiture, Brand Photography, C-Level Event Photography and Fine Art Photography','Headshots, employer-branding imagery, press portraits and visual brand strategy','AmCham Austria','memory, the body and biography','does the image carry real presence, or is it only arranged?'],
    block:'<section class="section-band client-decision-bridge" aria-labelledby="client-decision-title"><div class="wrap"><div class="section-head reveal"><span class="eyebrow">What this means in practice</span><h2 id="client-decision-title">One visual discipline, four clear ways to work together.</h2></div><div class="prose reveal structural-prose"><p>The professional work is organised into four principal services: <strong>Executive Portraiture, Brand Photography, C-Level Event Photography and Fine Art Photography.</strong> Headshots, employer-branding imagery, press portraits and visual brand strategy are tools within these areas—not extra categories you have to decode.</p><p>For a commission, I look for the image that makes a leader or organisation understandable before the first handshake. In autonomous series I slow down around memory, the body and biography. The purposes differ, but the test is the same: does the image carry real presence, or is it only arranged?</p><p>As a member of <a href="https://amcham.at/members-list/" rel="external">AmCham Austria</a>, BANHALMI works within an international business community where credibility, professional presence and long-term trust matter in practice—not merely in presentation.</p><a class="btn-link" href="#services">Choose the relevant starting point ↓</a></div></div></section>'
  },
  'hu/index.html':{
    ...
    newFacts:['vezetői portréfotózás, brandfotózás, felsővezetői eseményfotózás és művészi fotográfia','Az üzleti portré, a munkáltatói márkaépítés, a sajtóportré és a vizuális márkastratégia','AmCham Austria','emlékezet, a test és az élettörténet','valódi jelenlétet hordoz-e a kép, vagy csak gondosan elrendezett forma?'],
    block:'<section class="section-band client-decision-bridge" aria-labelledby="client-decision-title"><div class="wrap"><div class="section-head reveal"><span class="eyebrow">Mit jelent ez a gyakorlatban?</span><h2 id="client-decision-title">Egy vizuális szemlélet, négy egyértelmű együttműködési terület.</h2></div><div class="prose reveal structural-prose"><p>A szakmai munka négy fő területre épül: <strong>vezetői portréfotózás, brandfotózás, felsővezetői eseményfotózás és művészi fotográfia.</strong> Az üzleti portré, a munkáltatói márkaépítés, a sajtóportré és a vizuális márkastratégia ezeket támogatja — nem egymással versengő szolgáltatásként, hanem egy következetes képi rendszer eszközeiként.</p><p>Amikor megbízásra dolgozom, azt a képet keresem, amely már az első kézfogás előtt érthetővé tesz egy vezetőt vagy egy szervezetet. A saját sorozatokban az emlékezet, a test és az élettörténet körül lassítom le a folyamatot. A cél eltérő, a mérce ugyanaz: valódi jelenlétet hordoz-e a kép, vagy csak gondosan elrendezett forma?</p><p>Az <a href="https://amcham.at/members-list/" rel="external">AmCham Austria</a> tagjaként a BANHALMI olyan nemzetközi üzleti közösségben dolgozik, ahol a hitelesség, a professzionális jelenlét és a hosszú távú bizalom nem csupán kommunikációs ígéret, hanem mindennapi elvárás.</p><a class="btn-link" href="#services">A megfelelő kiindulópont kiválasztása ↓</a></div></div></section>'
  },
  'de-at/index.html':{
    ...
    newFacts:['Executive-Porträts, Brandfotografie, C-Level-Eventfotografie und Fine-Art-Fotografie','Headshots, Employer-Branding-Bilder, Presseporträts und visuelle Markenstrategie','AmCham Austria','Erinnerung, Körper und Biografie','Trägt das Bild wirkliche Präsenz, oder ist es nur arrangiert?'],
    block:'<section class="section-band client-decision-bridge" aria-labelledby="client-decision-title"><div class="wrap"><div class="section-head reveal"><span class="eyebrow">Was das in der Praxis bedeutet</span><h2 id="client-decision-title">Eine visuelle Disziplin, vier klare Formen der Zusammenarbeit.</h2></div><div class="prose reveal structural-prose"><p>Die professionelle Arbeit ist in vier Hauptleistungen gegliedert: <strong>Executive-Porträts, Brandfotografie, C-Level-Eventfotografie und Fine-Art-Fotografie.</strong> Headshots, Employer-Branding-Bilder, Presseporträts und visuelle Markenstrategie sind Werkzeuge innerhalb dieser Bereiche — keine zusätzlichen Kategorien, die zuerst entschlüsselt werden müssen.</p><p>Bei einem Auftrag suche ich das Bild, das eine Führungspersönlichkeit oder Organisation bereits vor dem ersten Händedruck verständlich macht. In freien Serien werde ich bei Erinnerung, Körper und Biografie langsamer. Die Zwecke unterscheiden sich, der Maßstab bleibt derselbe: Trägt das Bild wirkliche Präsenz, oder ist es nur arrangiert?</p><p>Als Mitglied der <a href="https://amcham.at/members-list/" rel="external">AmCham Austria</a> arbeitet BANHALMI in einer internationalen Wirtschaftsgemeinschaft, in der Glaubwürdigkeit, professioneller Auftritt und langfristiges Vertrauen praktische Anforderungen sind — nicht nur Teil der Außendarstellung.</p><a class="btn-link" href="#services">Den passenden Einstieg wählen ↓</a></div></div></section>'
  }
};
...
const errors=[];
const pages={
  'index.html':{heading:'One visual discipline, four clear ways to work together.',cta:'Choose the relevant starting point ↓',facts:['Executive Portraiture, Brand Photography, C-Level Event Photography and Fine Art Photography','Headshots, employer-branding imagery, press portraits and visual brand strategy','memory, the body and biography','AmCham Austria']},
  'hu/index.html':{heading:'Egy vizuális szemlélet, négy egyértelmű együttműködési terület.',cta:'A megfelelő kiindulópont kiválasztása ↓',facts:['vezetői portréfotózás, brandfotózás, felsővezetői eseményfotózás és művészi fotográfia','Az üzleti portré, a munkáltatói márkaépítés, a sajtóportré és a vizuális márkastratégia','emlékezet, a test és az élettörténet','AmCham Austria']},
  'de-at/index.html':{heading:'Eine visuelle Disziplin, vier klare Formen der Zusammenarbeit.',cta:'Den passenden Einstieg wählen ↓',facts:['Executive-Porträts, Brandfotografie, C-Level-Eventfotografie und Fine-Art-Fotografie','Headshots, Employer-Branding-Bilder, Presseporträts und visuelle Markenstrategie','Erinnerung, Körper und Biografie','AmCham Austria']}
};
